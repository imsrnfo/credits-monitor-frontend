...
const statuses: { value: Status; label: string }[] = [
  ...
  { value: 'COLLECTING', label: 'En cobranza' },
  { value: 'INVOICED', label: 'Facturado' },
  { value: 'INVOICING', label: 'Facturando' },
  { value: 'PAID', label: 'Pagado' },
  { value: 'PENDING', label: 'Pendiente' },
  { value: 'UNCOLLECTABLE', label: 'Incobrable' }
];

export default function InstallmentsBarChartOne() {
  ...
  }, [timeUnit, currentDate, selectedCountry, selectedStatus, selectedClient]);
