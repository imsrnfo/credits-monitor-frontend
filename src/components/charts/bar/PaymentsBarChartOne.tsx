...
type PaymentType = 'ALL' | 'ENDPOINT' | 'SAP' | 'LEGACY' | 'EDC' | 'OPEN_ITEMS' | 'SAP_1_0';
...
const paymentTypes: { value: PaymentType; label: string }[] = [
  ...
  { value: 'SAP_1_0', label: 'SAP 1.0' }
];

export default function PaymentsBarChartOne() {
  ...
  }, [timeUnit, currentDate, selectedCountry, selectedType, selectedClient]);
